  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden">
        ...
        {/* Header */}
        <div className="px-8 py-8 text-center bg-gradient-to-b from-blue-600 to-blue-500">
          <div className="text-4xl mb-2">💬</div>
          <h1 className="text-xl font-bold text-white">Claude AI</h1>
        ...
        <div className="px-8 py-7 space-y-5">
          ...
          <div className="space-y-3">
            <button onClick={() => handleOAuth("github")}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border
                         border-gray-300 dark:border-gray-700 text-sm text-gray-700 dark:text-gray-200
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-500">
            Demo account: <span className="font-mono">demo / demo</span>
          </p>
        </div>
      </div>
    </div>
